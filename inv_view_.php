...
<form name="formInv" method="post" action="invAction.php?ID=<?php echo $id;?>">
	<div id="divMSGblk2">
	<input id="btnSave" type="submit" name="Submit" value="Update" >
	<input id="btnDel" type="submit" name="Submit" value="Delete" >
	<input id="btnCancel" type="submit" name="Submit" value="Go Back" >
	</div>	
	<br>
	<br>
<table border="0" >
...
?>
<a  href="add_photo.php?ID=<?php echo $id;?>&year=<?php echo $year;?>&make=<?php echo $make;?>&model=<?php echo $model;?>"><img src="imgs/image.png " alt="imgs/image.png" width="30" style="vertical-align:middle"> Add Photos </a>
<br>
...
?>
<div class="img">
 <a target="_blank" href="<?php echo $target_path ;?> "><img src="<?php echo $target_path ;?> " alt="<?php echo $target_path ;?> " width="110" ></a>
 <div class="desc"><label><input type="checkbox" name="checkbox2[]" value="<?php echo $file_name_full;?>">Delete </label><?php echo $file_name;?></div>
</div>
<?php
};
if (!file_exists($filename)) {
